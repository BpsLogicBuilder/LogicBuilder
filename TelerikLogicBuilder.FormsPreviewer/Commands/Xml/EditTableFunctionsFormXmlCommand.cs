...
{
    internal class EditTableFunctionsFormXmlCommand : ClickCommandBase
    {
        private readonly IXmlDocumentHelpers _xmlDocumentHelpers;
        private readonly RadForm1 radForm;

        public EditTableFunctionsFormXmlCommand(IXmlDocumentHelpers xmlDocumentHelpers, RadForm1 radForm)
        {
        ...
        public override void Execute()
        {
            ...
            using IEditTableFunctionsFormXml editXmlForm = disposableManager.GetEditTableFunctionsFormXml
            (
