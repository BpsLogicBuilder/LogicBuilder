...
{
    public class ApiFileListDeleterTest : IClassFixture<ApiFileListDeleterFixture>
    {
        private readonly ApiFileListDeleterFixture _fixture;

        public ApiFileListDeleterTest(ApiFileListDeleterFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateApiFileListDeleter()
        {
            //arrange
            IApiFileListDeleter helper = _fixture.ServiceProvider.GetRequiredService<IApiFileListDeleter>();
    ...
    public class ApiFileListDeleterFixture : IDisposable
    {
        public ApiFileListDeleterFixture()
        {
