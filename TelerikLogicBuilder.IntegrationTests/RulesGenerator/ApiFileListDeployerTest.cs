...
{
    public class ApiFileListDeployerTest : IClassFixture<ApiFileListDeployerFixture>
    {
        private readonly ApiFileListDeployerFixture _fixture;

        public ApiFileListDeployerTest(ApiFileListDeployerFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateApiFileListDeployer()
        {
            //arrange
            IApiFileListDeployer helper = _fixture.ServiceProvider.GetRequiredService<IApiFileListDeployer>();
    ...
    public class ApiFileListDeployerFixture : IDisposable
    {
        public ApiFileListDeployerFixture()
        {
