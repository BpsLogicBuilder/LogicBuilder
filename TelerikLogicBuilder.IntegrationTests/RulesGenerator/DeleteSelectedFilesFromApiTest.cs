...
{
    public class DeleteSelectedFilesFromApiTest : IClassFixture<DeleteSelectedFilesFromApiFixture>
    {
        private readonly DeleteSelectedFilesFromApiFixture _fixture;

        public DeleteSelectedFilesFromApiTest(DeleteSelectedFilesFromApiFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDeleteSelectedFilesFromApi()
        {
            //arrange
            IDeleteSelectedFilesFromApi helper = _fixture.ServiceProvider.GetRequiredService<IDeleteSelectedFilesFromApi>();
    ...
    public class DeleteSelectedFilesFromApiFixture : IDisposable
    {
        public DeleteSelectedFilesFromApiFixture()
        {
