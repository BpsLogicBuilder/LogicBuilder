...
{
    public class DeploySelectedFilesToApiTest : IClassFixture<DeploySelectedFilesToApiFixture>
    {
        private readonly DeploySelectedFilesToApiFixture _fixture;

        public DeploySelectedFilesToApiTest(DeploySelectedFilesToApiFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDeploySelectedFilesToApi()
        {
            //arrange
            IDeploySelectedFilesToApi helper = _fixture.ServiceProvider.GetRequiredService<IDeploySelectedFilesToApi>();
    ...
    public class DeploySelectedFilesToApiFixture : IDisposable
    {
        public DeploySelectedFilesToApiFixture()
        {
