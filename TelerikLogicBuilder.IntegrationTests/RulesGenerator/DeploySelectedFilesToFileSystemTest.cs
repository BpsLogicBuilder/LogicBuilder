...
{
    public class DeploySelectedFilesToFileSystemTest : IClassFixture<DeploySelectedFilesToFileSystemFixture>
    {
        private readonly DeploySelectedFilesToFileSystemFixture _fixture;

        public DeploySelectedFilesToFileSystemTest(DeploySelectedFilesToFileSystemFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDeploySelectedFilesToFileSystem()
        {
            //arrange
            IDeploySelectedFilesToFileSystem helper = _fixture.ServiceProvider.GetRequiredService<IDeploySelectedFilesToFileSystem>();
    ...
    public class DeploySelectedFilesToFileSystemFixture : IDisposable
    {
        public DeploySelectedFilesToFileSystemFixture()
        {
