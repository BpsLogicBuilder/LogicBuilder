...
{
    public class FileSystemFileDeleterTest : IClassFixture<FileSystemFileDeleterFixture>
    {
        private readonly FileSystemFileDeleterFixture _fixture;

        public FileSystemFileDeleterTest(FileSystemFileDeleterFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateFileSystemFileDeleter()
        {
            //arrange
            IFileSystemFileDeleter helper = _fixture.ServiceProvider.GetRequiredService<IFileSystemFileDeleter>();
    ...
    public class FileSystemFileDeleterFixture : IDisposable
    {
        public FileSystemFileDeleterFixture()
        {
