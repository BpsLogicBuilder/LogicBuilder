...
{
    public class FileSystemFileDeployerTest : IClassFixture<FileSystemFileDeployerFixture>
    {
        private readonly FileSystemFileDeployerFixture _fixture;

        public FileSystemFileDeployerTest(FileSystemFileDeployerFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateFileSystemFileDeployer()
        {
            //arrange
            IFileSystemFileDeployer helper = _fixture.ServiceProvider.GetRequiredService<IFileSystemFileDeployer>();
    ...
    public class FileSystemFileDeployerFixture : IDisposable
    {
        public FileSystemFileDeployerFixture()
        {
