...
{
    public class BeginFlowRuleBuilderTest : IClassFixture<BeginFlowRuleBuilderFixture>
    {
        private readonly BeginFlowRuleBuilderFixture _fixture;

        public BeginFlowRuleBuilderTest(BeginFlowRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateBeginFlowRuleBuilder()
        {
            //arrange
            IBeginFlowRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IBeginFlowRuleBuilder>();
    ...
    public class BeginFlowRuleBuilderFixture : IDisposable
    {
        ...
        public BeginFlowRuleBuilderFixture()
        {
