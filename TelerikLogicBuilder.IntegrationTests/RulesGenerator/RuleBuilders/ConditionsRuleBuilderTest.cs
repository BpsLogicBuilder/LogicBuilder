...
{
    public class ConditionsRuleBuilderTest : IClassFixture<ConditionsRuleBuilderFixture>
    {
        private readonly ConditionsRuleBuilderFixture _fixture;

        public ConditionsRuleBuilderTest(ConditionsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateConditionsRuleBuilder()
        {
            //arrange
            IConditionsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IConditionsRuleBuilder>();
    ...
    public class ConditionsRuleBuilderFixture : IDisposable
    {
        ...
        public ConditionsRuleBuilderFixture()
        {
