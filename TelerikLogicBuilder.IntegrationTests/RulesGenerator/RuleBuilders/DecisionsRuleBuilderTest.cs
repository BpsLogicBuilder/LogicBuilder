...
{
    public class DecisionsRuleBuilderTest : IClassFixture<DecisionsRuleBuilderFixture>
    {
        private readonly DecisionsRuleBuilderFixture _fixture;

        public DecisionsRuleBuilderTest(DecisionsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDecisionsRuleBuilder()
        {
            //arrange
            IDecisionsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IDecisionsRuleBuilder>();
    ...
    public class DecisionsRuleBuilderFixture : IDisposable
    {
        ...
        public DecisionsRuleBuilderFixture()
        {
