...
{
    public class DialogWithExitsRuleBuilderTest : IClassFixture<DialogWithExitsRuleBuilderFixture>
    {
        private readonly DialogWithExitsRuleBuilderFixture _fixture;

        public DialogWithExitsRuleBuilderTest(DialogWithExitsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDialogWithExitsRuleBuilder()
        {
            //arrange
            IDialogWithExitsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IDialogWithExitsRuleBuilder>();
    ...
    public class DialogWithExitsRuleBuilderFixture : IDisposable
    {
        ...
        public DialogWithExitsRuleBuilderFixture()
        {
