...
{
    public class DialogWithoutExitsRuleBuilderTest : IClassFixture<DialogWithoutExitsRuleBuilderFixture>
    {
        private readonly DialogWithoutExitsRuleBuilderFixture _fixture;

        public DialogWithoutExitsRuleBuilderTest(DialogWithoutExitsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateDialogWithoutExitsRuleBuilder()
        {
            //arrange
            IDialogWithoutExitsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IDialogWithoutExitsRuleBuilder>();
    ...
    public class DialogWithoutExitsRuleBuilderFixture : IDisposable
    {
        ...
        public DialogWithoutExitsRuleBuilderFixture()
        {
