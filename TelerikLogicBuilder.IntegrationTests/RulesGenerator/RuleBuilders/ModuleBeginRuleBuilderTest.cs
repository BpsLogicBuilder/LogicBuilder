...
{
    public class ModuleBeginRuleBuilderTest : IClassFixture<ModuleBeginRuleBuilderFixture>
    {
        private readonly ModuleBeginRuleBuilderFixture _fixture;

        public ModuleBeginRuleBuilderTest(ModuleBeginRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateModuleBeginRuleBuilder()
        {
            //arrange
            IModuleBeginRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IModuleBeginRuleBuilder>();
    ...
    public class ModuleBeginRuleBuilderFixture : IDisposable
    {
        ...
        public ModuleBeginRuleBuilderFixture()
        {
