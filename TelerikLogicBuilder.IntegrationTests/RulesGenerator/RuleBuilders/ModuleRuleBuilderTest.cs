...
{
    public class ModuleRuleBuilderTest : IClassFixture<ModuleRuleBuilderFixture>
    {
        private readonly ModuleRuleBuilderFixture _fixture;

        public ModuleRuleBuilderTest(ModuleRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateModuleRuleBuilder()
        {
            //arrange
            IModuleRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IModuleRuleBuilder>();
    ...
    public class ModuleRuleBuilderFixture : IDisposable
    {
        ...
        public ModuleRuleBuilderFixture()
        {
