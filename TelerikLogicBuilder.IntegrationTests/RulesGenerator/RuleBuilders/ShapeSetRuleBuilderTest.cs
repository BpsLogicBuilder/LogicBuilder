...
{
    public class ShapeSetRuleBuilderTest : IClassFixture<ShapeSetRuleBuilderFixture>
    {
        private readonly ShapeSetRuleBuilderFixture _fixture;

        public ShapeSetRuleBuilderTest(ShapeSetRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateShapeSetRuleBuilder()
        {
            //arrange
            IShapeSetRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IShapeSetRuleBuilder>();
    ...
    public class ShapeSetRuleBuilderFixture : IDisposable
    {
        ...
        public ShapeSetRuleBuilderFixture()
        {
