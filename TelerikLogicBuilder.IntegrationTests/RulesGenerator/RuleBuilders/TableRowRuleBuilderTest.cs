...
{
    public class TableRowRuleBuilderTest : IClassFixture<TableRowRuleBuilderFixture>
    {
        private readonly TableRowRuleBuilderFixture _fixture;

        public TableRowRuleBuilderTest(TableRowRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateTableRowRuleBuilder()
        {
            //arrange
            ITableRowRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<ITableRowRuleBuilder>();
    ...
    public class TableRowRuleBuilderFixture : IDisposable
    {
        ...
        public TableRowRuleBuilderFixture()
        {
