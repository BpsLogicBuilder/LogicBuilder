...
{
    public class WaitConditionsRuleBuilderTest : IClassFixture<WaitConditionsRuleBuilderFixture>
    {
        private readonly WaitConditionsRuleBuilderFixture _fixture;

        public WaitConditionsRuleBuilderTest(WaitConditionsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateWaitConditionsRuleBuilder()
        {
            //arrange
            IWaitConditionsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IWaitConditionsRuleBuilder>();
    ...
    public class WaitConditionsRuleBuilderFixture : IDisposable
    {
        ...
        public WaitConditionsRuleBuilderFixture()
        {
