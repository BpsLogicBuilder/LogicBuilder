...
{
    public class WaitDecisionsRuleBuilderTest : IClassFixture<WaitDecisionsRuleBuilderFixture>
    {
        private readonly WaitDecisionsRuleBuilderFixture _fixture;

        public WaitDecisionsRuleBuilderTest(WaitDecisionsRuleBuilderFixture fixture)
        {
            _fixture = fixture;
        }

        [Fact]
        public void CanCreateWaitDecisionsRuleBuilder()
        {
            //arrange
            IWaitDecisionsRuleBuilder builder = _fixture.ServiceProvider.GetRequiredService<IWaitDecisionsRuleBuilder>();
    ...
    public class WaitDecisionsRuleBuilderFixture : IDisposable
    {
        ...
        public WaitDecisionsRuleBuilderFixture()
        {
