...
{
    internal partial class ConfigureFunctionsAddStandardFunctionCommand : ClickCommandBase
    {
        ...
        public ConfigureFunctionsAddStandardFunctionCommand(
        ...
        private void AddStandardFunction()
        {
