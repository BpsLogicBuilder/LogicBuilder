...
{
    internal class ReplaceWithLiteralParameterCommand : ClickCommandBase
    {
        ...
        public ReplaceWithLiteralParameterCommand(
        ...
        public override void Execute()
        {
            ...
            if (!_treeViewService.IsGenericArgumentParameterNode(existingTreeNode))
                throw _exceptionHelper.CriticalException("{9DEF155C-1E98-4B40-8CFA-96610DC5AFB0}");
            ...
            try
            {
                ...
                (
                    ...
                    (
                        ...
                        (
                            _genericConfigManager.GetDefaultLiteralGenericConfig
                            (
