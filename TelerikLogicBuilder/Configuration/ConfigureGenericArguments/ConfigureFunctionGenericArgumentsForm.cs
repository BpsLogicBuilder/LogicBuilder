...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ConfigureFunctionGenericArgumentsForm_Disposed;
            FormClosing += ConfigureFunctionGenericArgumentsForm_FormClosing;
        ...
        private void ConfigureFunctionGenericArgumentsForm_Disposed(object? sender, EventArgs e)
        {
            RemoveEventHandlers();
            RemoveClickCommands();
        }
