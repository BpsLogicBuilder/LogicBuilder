...
namespace ABIS.LogicBuilder.FlowBuilder.Configuration.ConfigureVariables.ConfigureObjectVariable
{
    internal partial class ConfigureObjectVariableControl : UserControl, IConfigureObjectVariableControl
    {
        ...
        public void SetControlValues(RadTreeNode treeNode)
        {
            ...
            txtCvName.Text = variableElement.Attributes[XmlDataConstants.NAMEATTRIBUTE]!.Value;
            txtCvName.Select();
            txtCvName.SelectAll();
        ...
        {
            Disposed += ConfigureObjectVariableControl_Disposed;
        ...
        private void ConfigureObjectVariableControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
