...
{
    internal partial class ConfigureProjectProperties : RadForm, IConfigureProjectProperties
    {
        private readonly IConfigurationControlFactory _configurationControlFactory;
        ...
        public ConfigureProjectProperties(
        ...
        private void UpdateXmlDocument(RadTreeNode treeNode)
        {
            ...
            if (splitPanelRight.Controls[0] is not IXmlElementControl xmlElementControl)
