...
namespace ABIS.LogicBuilder.FlowBuilder.Editing.EditLiteralList
{
    internal partial class EditParameterLiteralListForm : Telerik.WinControls.UI.RadForm, IEditParameterLiteralListForm
    {
        ...
        private void Initialize()
        {
            ...
            Disposed += EditParameterLiteralListForm_Disposed;
            ...
            btnPasteXmlClickHandler = AddButtonClickCommand(_editLiteralListCommandFactory.GetEditParameterLiteralListFormXmlCommand(this));
            LoadTreeview();
            AddClickCommands();
        }
        ...
        private void EditParameterLiteralListForm_Disposed(object? sender, EventArgs e)
        {
            RemoveClickCommands();
            RemoveEventHandlers();
        }
