...
namespace ABIS.LogicBuilder.FlowBuilder.Editing.EditObjectList
{
    internal partial class EditVariableObjectListForm : Telerik.WinControls.UI.RadForm, IEditVariableObjectListForm
    {
        ...
        private void Initialize()
        {
            ...
            Disposed += EditVariableObjectListForm_Disposed;
            ...
            btnPasteXmlClickHandler = AddButtonClickCommand(_editObjectListCommandFactory.GetEditVariableObjectListFormXmlCommand(this));
            LoadTreeview();
            AddClickCommands();
        }
        ...
        private void EditVariableObjectListForm_Disposed(object? sender, EventArgs e)
        {
            RemoveClickCommands();
            RemoveEventHandlers();
        }
