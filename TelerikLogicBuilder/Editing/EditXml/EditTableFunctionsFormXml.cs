...
{
    internal partial class EditTableFunctionsFormXml : Telerik.WinControls.UI.RadForm, IEditTableFunctionsFormXml
    {
        ...
        public EditTableFunctionsFormXml(
        ...
        {//UnFormattedXmlElement.Name is valid if the schema is valid. ValidateSchema() will be called before ValidateElement().
            ...
            foreach (XmlElement functionElement in functionsData.FunctionElements)
            {
                ...
                if (!_functionHelper.IsVoid(function) || function.FunctionCategory == FunctionCategories.DialogForm)
