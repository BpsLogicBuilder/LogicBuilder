...
{
    internal partial class ListOfLiteralsItemRichInputBoxControl : UserControl, IListOfLiteralsItemRichInputBoxControl
    {
        ...
        public ListOfLiteralsItemRichInputBoxControl(
