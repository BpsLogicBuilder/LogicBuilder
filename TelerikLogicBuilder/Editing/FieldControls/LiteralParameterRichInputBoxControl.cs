...
namespace ABIS.LogicBuilder.FlowBuilder.Editing.FieldControls
{
    internal partial class LiteralParameterRichInputBoxControl : UserControl, ILiteralParameterRichInputBoxControl
    {
        ...
        public RadButton BtnConstructor => btnConstructor;
        public RadButton BtnFunction => btnFunction;
        public RadButton BtnVariable => btnVariable;
        ...
        public void SetErrorBackColor()
        {
            ...
            SetPanelBorderForeColor(radPanelCommandBar, errorColor);
        }
        ...
        public void SetNormalBackColor()
        {
            ...
            SetPanelBorderForeColor(radPanelCommandBar, normalColor);
        }
        ...
        private void InitializeButtons() 
            ...
            (
                radPanelCommandBar,
                new RadButton[] { btnVariable, btnFunction, btnConstructor }
            );
