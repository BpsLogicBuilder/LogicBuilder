...
{
    internal partial class ListOfLiteralsParameterItemDomainMultilineControl : UserControl, IListOfLiteralsParameterItemDomainMultilineControl
    {
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ListOfLiteralsParameterItemDomainMultilineControl_Disposed;
        ...
        private void ListOfLiteralsParameterItemDomainMultilineControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
