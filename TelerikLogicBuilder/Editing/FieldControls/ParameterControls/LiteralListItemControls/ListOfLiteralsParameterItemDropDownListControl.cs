...
{
    internal partial class ListOfLiteralsParameterItemDropDownListControl : UserControl, IListOfLiteralsParameterItemDropDownListControl
    {
        ...
        public ListOfLiteralsParameterItemDropDownListControl(
        ...
        private void Initialize()
        {
            ...
            Disposed += ListOfLiteralsParameterItemDropDownListControl_Disposed;
        ...
        private void ListOfLiteralsParameterItemDropDownListControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
