        ...
        public string VisibleText
        {
            get
            {
                ...
                (
                    ...
                    (
                        XmlElement.OuterXml,//OuterXml element is literalListParameter
                        Application
                    )
                );
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += LiteralListParameterRichTextBoxControl_Disposed;
        ...
        private void LiteralListParameterRichTextBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
