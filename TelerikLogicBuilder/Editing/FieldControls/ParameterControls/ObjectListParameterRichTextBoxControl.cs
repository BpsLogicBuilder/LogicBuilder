...
{
    internal partial class ObjectListParameterRichTextBoxControl : UserControl, IObjectListParameterRichTextBoxControl
    {
        ...
        public Type? AssignedTo
        {
            get
            {
                ...
                Type? GetAssignedTo()
                {
                    _typeLoadHelper.TryGetSystemType(listOfObjectsParameter, Application, out Type? type);
                    return type;
                }
            }
        }
        ...
        public ObjectListParameterElementInfo ObjectListElementInfo => _objectListParameterElementInfoHelper.GetObjectListElementInfo(listOfObjectsParameter);
        ...
        public void UpdateXmlElement(string innerXml)
        {
            ...
            using (XmlWriter xmlTextWriter = _xmlDocumentHelpers.CreateUnformattedXmlWriter(stringBuilder))
            {
                xmlTextWriter.WriteStartElement(XmlDataConstants.OBJECTLISTPARAMETERELEMENT);
                    xmlTextWriter.WriteAttributeString(XmlDataConstants.NAMEATTRIBUTE, listOfObjectsParameter.Name);
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ObjectListParameterRichTextBoxControl_Disposed;
        ...
        private void ObjectListParameterRichTextBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
