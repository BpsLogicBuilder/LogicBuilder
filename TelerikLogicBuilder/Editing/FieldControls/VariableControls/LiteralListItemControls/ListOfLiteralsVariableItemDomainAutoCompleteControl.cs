...
{
    internal partial class ListOfLiteralsVariableItemDomainAutoCompleteControl : UserControl, IListOfLiteralsVariableItemDomainAutoCompleteControl
    {
        ...
        public ListOfLiteralsVariableItemDomainAutoCompleteControl(
        ...
        private void Initialize()
        {
            ...
            _radDropDownListHelper.LoadTextItems(radDropDownList, literalListVariable.Domain, RadDropDownStyle.DropDown);

            Disposed += ListOfLiteralsVariableItemDomainAutoCompleteControl_Disposed;
        ...
        private void ListOfLiteralsVariableItemDomainAutoCompleteControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
