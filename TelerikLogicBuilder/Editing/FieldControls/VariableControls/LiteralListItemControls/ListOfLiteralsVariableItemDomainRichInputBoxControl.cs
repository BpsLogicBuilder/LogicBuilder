...
{
    internal partial class ListOfLiteralsVariableItemDomainRichInputBoxControl : UserControl, IListOfLiteralsVariableItemDomainRichInputBoxControl
    {
        ...
        private readonly ListOfLiteralsVariable literalListVariable;
        ...
        public ListOfLiteralsVariableItemDomainRichInputBoxControl(
            ...
            ListOfLiteralsVariable literalListVariable)
        {
            ...
            this.literalListVariable = literalListVariable;
        ...
        public Type AssignedTo
        {
            get
            {
                ...
                Type GetAssignedTo()
                {
                    Type type = _enumHelper.GetSystemType(literalListVariable.LiteralType);
        ...
        public string Comments => literalListVariable.Comments;

        public IList<string> Domain => literalListVariable.Domain;
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ListOfLiteralsVariableItemDomainRichInputBoxControl_Disposed;
        ...
        private void ListOfLiteralsVariableItemDomainRichInputBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
