...
{
    internal partial class ListOfLiteralsVariableItemDropDownListControl : UserControl, IListOfLiteralsVariableItemDropDownListControl
    {
        ...
        public ListOfLiteralsVariableItemDropDownListControl(
        ...
        {
            if (literalListVariable.Domain.ToHashSet().Contains(xmlElement.InnerText))
        ...
        private void Initialize()
        {
            ...
            _radDropDownListHelper.LoadTextItems(radDropDownList, literalListVariable.Domain);
            if (literalListVariable.Domain.Count > 0)
                radDropDownList.SelectedIndex = 0;

            Disposed += ListOfLiteralsVariableItemDropDownListControl_Disposed;
        ...
        private void ListOfLiteralsVariableItemDropDownListControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
