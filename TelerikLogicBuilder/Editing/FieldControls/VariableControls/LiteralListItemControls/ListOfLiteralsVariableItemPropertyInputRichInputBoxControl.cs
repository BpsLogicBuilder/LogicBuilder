...
{
    internal partial class ListOfLiteralsVariableItemPropertyInputRichInputBoxControl : UserControl, IListOfLiteralsVariableItemPropertyInputRichInputBoxControl
    {
        ...
        public string? SourceClassName => literalListVariable.PropertySource;
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ListOfLiteralsVariableItemPropertyInputRichInputBoxControl_Disposed;
        ...
        private void ListOfLiteralsVariableItemPropertyInputRichInputBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
