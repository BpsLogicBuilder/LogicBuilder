...
{
    internal partial class ListOfLiteralsVariableItemTypeAutoCompleteControl : UserControl, IListOfLiteralsVariableItemTypeAutoCompleteControl
    {
        ...
        public ListOfLiteralsVariableItemTypeAutoCompleteControl(
        ...
        private void Initialize()
        {
            ...
            this.Disposed += ListOfLiteralsVariableItemTypeAutoCompleteControl_Disposed;
        ...
        private void ListOfLiteralsVariableItemTypeAutoCompleteControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
