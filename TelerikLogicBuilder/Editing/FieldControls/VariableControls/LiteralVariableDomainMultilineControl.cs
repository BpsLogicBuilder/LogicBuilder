...
{
    internal partial class LiteralVariableDomainMultilineControl : UserControl, ILiteralVariableDomainMultilineControl
    {
        ...
        public LiteralVariableDomainMultilineControl(
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += LiteralVariableDomainMultilineControl_Disposed;
        ...
        private void LiteralVariableDomainMultilineControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
