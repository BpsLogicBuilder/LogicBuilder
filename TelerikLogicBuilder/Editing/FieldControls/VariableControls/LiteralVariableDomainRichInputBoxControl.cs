...
{
    internal partial class LiteralVariableDomainRichInputBoxControl : UserControl, ILiteralVariableDomainRichInputBoxControl
    {
        ...
        public LiteralVariableDomainRichInputBoxControl(
        ...
        public IList<string> Domain => literalVariable.Domain;
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += LiteralVariableDomainRichInputBoxControl_Disposed;
        ...
        private void LiteralVariableDomainRichInputBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
