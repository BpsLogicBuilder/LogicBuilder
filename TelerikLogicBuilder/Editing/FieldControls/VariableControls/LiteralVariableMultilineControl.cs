...
{
    internal partial class LiteralVariableMultilineControl : UserControl, ILiteralVariableMultilineControl
    {
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += LiteralVariableMultilineControl_Disposed;
        ...
        private void LiteralVariableMultilineControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
