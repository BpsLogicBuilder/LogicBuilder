...
{
    internal partial class LiteralVariablePropertyInputRichInputBoxControl : UserControl, ILiteralVariablePropertyInputRichInputBoxControl
    {
        ...
        private readonly IVariableRichInputBoxEventsHelper _richInputBoxEventsHelper;
        ...
        public LiteralVariablePropertyInputRichInputBoxControl(
        ...
        public string Comments => literalVariable.Comments;

        public string? SourceClassName => literalVariable.PropertySource;
        ...
        public Type AssignedTo
        {
            get
            {
                ...
                Type GetAssignedTo()
                {
                    Type type = _enumHelper.GetSystemType(literalVariable.LiteralType);
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += LiteralVariablePropertyInputRichInputBoxControl_Disposed;
        ...
        private void LiteralVariablePropertyInputRichInputBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
