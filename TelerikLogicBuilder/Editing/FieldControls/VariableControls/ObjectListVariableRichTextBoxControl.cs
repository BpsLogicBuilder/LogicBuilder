...
{
    internal partial class ObjectListVariableRichTextBoxControl : UserControl, IObjectListVariableRichTextBoxControl
    {
        ...
        private readonly ListOfObjectsVariable listOfObjectsVariable;
        ...
        public ObjectListVariableRichTextBoxControl(
            ...
            ListOfObjectsVariable listOfObjectsVariable)
        {
            InitializeComponent();
            ...
            this.listOfObjectsVariable = listOfObjectsVariable;
        ...
        public Type? AssignedTo
        {
            get
            {
                ...
                Type? GetAssignedTo()
                {
                    _typeLoadHelper.TryGetSystemType(listOfObjectsVariable, Application, out Type? type);
                    return type;
                }
            }
        }
        ...
        public string VisibleText
        {
            get
            {
                ...
                (
                    ...
                    (
                        XmlElement.OuterXml,//OuterXml element is objectListVariable
                        Application
                    )
                );
        ...
        public ObjectListVariableElementInfo ObjectListElementInfo => _objectListVariableElementInfoHelper.GetObjectListElementInfo(listOfObjectsVariable);
        ...
        public void UpdateXmlElement(string innerXml)
        {
            XmlElement = _xmlDocumentHelpers.ToXmlElement
            (
                _xmlDataHelper.BuildVariableValueXml(listOfObjectsVariable, innerXml)
            );
        }
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ObjectListVariableRichTextBoxControl_Disposed;
        ...
        private void ObjectListVariableRichTextBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
