...
{
    internal partial class ObjectVariableRichTextBoxControl : UserControl, IObjectVariableRichTextBoxControl
    {
        ...
        public ObjectVariableRichTextBoxControl(
        ...
        public Type? AssignedTo
        {
            get
            {
                ...
                Type? GetAssignedTo()
                {
                    _typeLoadHelper.TryGetSystemType(objectVariable, Application, out Type? type);
                    return type;
                }
            }
        }
        ...
        public string VisibleText
        {
            get
            {
                ...
                (
                    ...
                    (
                        XmlElement.OuterXml,//OuterXml element is objectVariable
                        Application
                    )
                );
        ...
        public void UpdateXmlElement(string innerXml)
        {
            XmlElement = _xmlDocumentHelpers.ToXmlElement
            (
                _xmlDataHelper.BuildVariableValueXml(objectVariable, innerXml)
            );
        }
...
#pragma warning restore CS3016 // Arrays as attribute arguments is not CLS-compliant
        private void Initialize()
        {
            ...
            Disposed += ObjectVariableRichTextBoxControl_Disposed;
        ...
        private void ObjectVariableRichTextBoxControl_Disposed(object? sender, EventArgs e)
        {
            toolTip.RemoveAll();
            toolTip.Dispose();
