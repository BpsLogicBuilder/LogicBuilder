...
{
    internal class GetRuleShapesUtility
    {
        ...
        public GetRuleShapesUtility(IExceptionHelper exceptionHelper, IJumpDataParser jumpDataParser, IShapeHelper shapeHelper, IShapeXmlHelper shapeXmlHelper, IXmlDocumentHelpers xmlDocumentHelpers, IDictionary<string, Shape> jumpToShapes)
        {
        ...
        internal void GetShapes(Shape connector, IList<ShapeBag> ruleShapes, IList<Shape> ruleConnectors)
        {
