...
{
    internal class BeginFlowRuleBuilderUtility : ShapeSetRuleBuilderUtility
    {
        public BeginFlowRuleBuilderUtility(
        ...
        internal override void GenerateRules()
        {
            ...
            ThenActions.Add(new RuleStatementAction(new CodeMethodInvokeExpression(DirectorReference, RuleFunctionConstants.SETMODULENAMEFUNCTIONNAME, new CodeExpression[] { new CodePrimitiveExpression(this.ModuleName) })));
