...
{
    internal class ModuleRuleBuilderUtility : ShapeSetRuleBuilderUtility
    {
        private readonly IShapeHelper _shapeHelper;

        public ModuleRuleBuilderUtility(
        ...
        internal override void GenerateRules()
        {
            ...
            string externalModuleShapeXml = _shapeXmlHelper.GetXmlString(RuleShapes[0].Shape);
            ...
            Conditions.Add(new IfCondition(CodeExpressionBuilderUtility.BuildDirectorPropertyCondition(DirectorProperties.MODULEENDPROPERTY, new CodePrimitiveExpression(externalModule))));
