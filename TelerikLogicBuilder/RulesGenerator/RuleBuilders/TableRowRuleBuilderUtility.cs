...
{
    internal class TableRowRuleBuilderUtility
    {
        ...
        public TableRowRuleBuilderUtility(
            DataRow dataRow,
            string moduleName,
            int ruleCount,
            ...
            ITableResourcesManager tableResourcesManager,
        ...
        private readonly CodeExpressionBuilderUtility codeExpressionBuilderUtility;

        private ApplicationTypeInfo Application { get; }
        private IDictionary<string, string> ResourceStrings { get; }
        ...
        internal IList<WorkflowRules.Rule> Rules => GetRules();
        ...
        /// <summary>
        /// generates all rules for the row
        /// </summary>
        ...
        private void NoConditionsRule()
        {
            ...
            (
                new IfCondition
                (
                    CodeExpressionBuilderUtility.BuildDirectorPropertyCondition
                    (
